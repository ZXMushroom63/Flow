...
function getRed(auto = false) {
  if (!auto) {
    rentex.redNode = document.querySelector(".node .header[data-redoutput]");
  }
  if (!rentex.redNode) {
    if (!auto) {
      alert(
...
function getAlpha(auto = false) {
  if (!auto) {
    rentex.alphaNode = document.querySelector(
...
function getGreen(auto = false) {
  if (!auto) {
    rentex.greenNode = document.querySelector(
...
function getBlue(auto = false) {
  if (!auto) {
    rentex.blueNode = document.querySelector(".node .header[data-blueoutput]");
  }
  if (!rentex.blueNode) {
    if (!auto) {
      alert(
